...
namespace google\appengine_datastore_v3 {
  class Cost extends \google\net\ProtocolMessage {
    ...
    public function getWriteUnits() {
      if (!isset($this->write_units)) {
        return 0;
      }
      return $this->write_units;
    }
    public function setWriteUnits($val) {
      $this->write_units = $val;
      return $this;
    }
    public function clearWriteUnits() {
      unset($this->write_units);
      return $this;
    }
    public function hasWriteUnits() {
      return isset($this->write_units);
    }
    public function clear() {
    ...
    public function byteSizePartial() {
      ...
      if (isset($this->write_units)) {
        $res += 1;
        $res += $this->lengthVarInt64($this->write_units);
      }
      return $res;
    }
    public function outputPartial($out) {
      ...
      if (isset($this->write_units)) {
        $out->putVarInt32(80);
        $out->putVarInt32($this->write_units);
      }
    }
    public function tryMerge($d) {
      while($d->avail() > 0) {
        ...
        switch ($tt) {
          ...
          case 72:
            ...
            break;
          case 80:
            $this->setWriteUnits($d->getVarInt32());
            break;
          case 0:
            throw new \google\net\ProtocolBufferDecodeError();
            break;
    ...
    public function mergeFrom($x) {
      ...
      if ($x->hasWriteUnits()) {
        $this->setWriteUnits($x->getWriteUnits());
      }
    }
    public function equals($x) {
      if ($x === $this) { return true; }
      ...
      if (isset($this->write_units) !== isset($x->write_units)) return false;
      if (isset($this->write_units) && !$this->integerEquals($this->write_units, $x->write_units)) return false;
      return true;
    }
    public function shortDebugString($prefix = "") {
      $res = '';
      ...
      if (isset($this->write_units)) {
        $res .= $prefix . "write_units: " . $this->debugFormatInt32($this->write_units) . "\n";
      }
      return $res;
    }
  }
